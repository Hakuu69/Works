...
<header>
  <a href="#home" class="xx"><img src="!SIGNUP/images/logo.png" height = "50" width = "50">  | WORKS</a>
              ...
              <div class="row align-content-md-center"> 
                ...
                <div class="row">
                    <div class="col-md-4 text-center featured">
                        <img src="!SIGNUP/images/logo.png" width="" height="270" alt="">
                        <br><br>
                            <h5>Carl Patrick Mallari - <strong>Member</strong></h5>
                        <br>
                          <p style="font-size: 11px; color:black;">3rd Year at AMA Computer College</p>

                    <button class="btn bg-warning"> <a href="https://www.facebook.com/carl.patrick.mallari.2024/" style="color: white;"> View Profile</a></button>
                        <br><br>
                    </div>
                    ...
                    <button class="btn bg-warning"> <a href="https://www.facebook.com/Jacob.gsalvador" style="color: white;"> View Profile</a></button>
                        <br><br>
                    </div>
                    ...
                    <div class="col-md-4 text-center featured">
                        ...
                        <p style="font-size: 11px; color:black;">3rd Year at AMA Computer College</p>
                        <br>
                    <button class="btn bg-warning"> <a href="https://www.facebook.com/oksy.0" style="color: white;"> View Profile</a></button>
                        <br><br>
                    </div>
                </section>  
